exports.initialize = function() {
  ...
  exports.use = async function(args, initiator) {
    ...
    if(initiator.playerData["permission"] < 50) return MMO_Core["socket"].modules["messages"].sendToPlayer(initiator, "System", "You don't have the permission to kick a player.", "error");    
