exports.initialize = function() {
  ...
  exports.use = async function(args, initiator) {
    ...
    if(args[1] === initiator.playerData.username) return MMO_Core["socket"].modules["messages"].sendToPlayer(initiator, "System", `You can't give money to yourself.`, "error");    
    ...
    if(args[2] > initiator.playerData.stats.gold) return MMO_Core["socket"].modules["messages"].sendToPlayer(initiator, "System", `Amount is not valid.`, "error");    
