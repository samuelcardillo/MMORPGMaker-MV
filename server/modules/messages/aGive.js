exports.initialize = function () {
  ...
  exports.use = async function (args, initiator) {
    ...
    if (args[2] === "gold") {
      ...
      if (itemId > 0) {
        if (players[args[1]].playerData.stats[args[2]].includes(itemId)) return MMO_Core["socket"].modules["messages"].sendToPlayer(initiator, "System", `${players[args[1]].playerData.username} already has this skill.`, "action");
        else players[args[1]].playerData.stats.skills.push(itemId);
