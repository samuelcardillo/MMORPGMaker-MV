...
this._restorationOfStatesFlag=true;this.contextStates.save();this.nativeptr=Core.Init(settings.instanceMaxCount,settings.squareMaxCount);this.contextStates.restore();}
...
},{key:"draw",value:function draw(){this._makeContextCurrent();var program=null;if(this._restorationOfStatesFlag){program=this.gl.getParameter(gl.CURRENT_PROGRAM);this.contextStates.save();}
Core.Draw(this.nativeptr);if(this._restorationOfStatesFlag){this.contextStates.restore();this.gl.useProgram(program);}}},{key:"beginDraw",value:function beginDraw(){if(this._restorationOfStatesFlag){this.contextStates.save();}
...
},{key:"setRestorationOfStatesFlag",value:function setRestorationOfStatesFlag(flag){this._restorationOfStatesFlag=flag;Core.SetRestorationOfStatesFlag(this.nativeptr,flag);}}]);return EffekseerContext;}();var Effekseer=function(){function Effekseer(){_classCallCheck(this,Effekseer);}
